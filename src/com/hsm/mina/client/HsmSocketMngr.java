...
public class HsmSocketMngr {
	...
	private List<HsmSocket> m_connections;
	private Object m_mutex = new Object(); //if resource is useless, thread shoud wait until resouce is available
	...
	public List<HsmSocket> getConnections() {
